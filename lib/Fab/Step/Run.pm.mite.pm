...
sub new {
    ...
    # param declaration, file lib/Fab/Step.pm, line 6
    ...
    # param declaration, file lib/Fab/Step.pm, line 12
    ...
    # param declaration, file lib/Fab/Step/Run.pm, line 10
    ...
    # param declaration, file lib/Fab/Step/Run.pm, line 15
    ...
    my @unknown = grep not( /\A(?:args|command|definition_context|task)\z/ ), keys %{$args}; @unknown and croak( "Unexpected keys in constructor: " . join( q[, ], sort @unknown ) );
...
if ( $__XS ) {
    ...
    *args = sub { @_ == 1 or croak( 'Reader "args" usage: $self->args()' ); $_[0]{"args"} };
}
...
if ( $__XS ) {
    ...
    *command = sub { @_ == 1 or croak( 'Reader "command" usage: $self->command()' ); $_[0]{"command"} };
}
