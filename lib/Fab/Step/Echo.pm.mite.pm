...
# Mite keywords
BEGIN {
    my ( $SHIM, $CALLER ) = ( "Fab::Mite", "Fab::Step::Echo" );
...
sub new {
    ...
    # param declaration, file /home/tai/src/p5/p5-fab/lib/Fab/Step/Echo.pm, line 11
    ...
    my @unknown = grep not( /\A(?:args|definition_context|task)\z/ ), keys %{$args}; @unknown and croak( "Unexpected keys in constructor: " . join( q[, ], sort @unknown ) );
